...
PYTHONPATH=src python -m oracle_runner observe-social-signal --platform x --signal-url https://example.com/post/1 --content-hash abc123
PYTHONPATH=src python -m oracle_runner emit-social-signal --agent-id ag_... --platform x --signal-url https://example.com/post/1
PYTHONPATH=src python -m oracle_runner sync-social-signals
PYTHONPATH=src python -m oracle_runner observe-customer-referral --source-system hubspot --external-ref lead_1 --stage lead_detected
PYTHONPATH=src python -m oracle_runner emit-customer-referral --agent-id ag_... --referral-id lead_1 --stage verified_lead
PYTHONPATH=src python -m oracle_runner sync-customer-referrals
...
PYTHONPATH=src python -m oracle_runner --json open-platform-funding-round --title "Platform Round 1"
PYTHONPATH=src python -m oracle_runner --json close-platform-funding-round --round-id pfr_...
PYTHONPATH=src python -m oracle_runner --json sync-project-capital
PYTHONPATH=src python -m oracle_runner --json sync-platform-funding
...
PYTHONPATH=src python -m oracle_runner --json observe-social-signal --platform x --signal-url https://example.com/post/1
PYTHONPATH=src python -m oracle_runner --json emit-social-signal --agent-id ag_... --platform x --signal-url https://example.com/post/1
PYTHONPATH=src python -m oracle_runner --json sync-social-signals
PYTHONPATH=src python -m oracle_runner --json observe-customer-referral --source-system hubspot --external-ref lead_1 --stage lead_detected
PYTHONPATH=src python -m oracle_runner --json emit-customer-referral --agent-id ag_... --referral-id lead_1 --stage verified_lead
PYTHONPATH=src python -m oracle_runner --json sync-customer-referrals
