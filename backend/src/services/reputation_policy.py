...
REPUTATION_SOURCE_POLICIES: tuple[ReputationSourcePolicy, ...] = (
    ...
    ReputationSourcePolicy(
        ...
        formula="Awarded on oracle-verified platform bounty eligibility for launch-critical hardening work in the core repo; requires explicit hardening signals.",
        status="active",
    ),
    ReputationSourcePolicy(
        ...
        default_delta_points=200,
        formula="Awarded on oracle-verified platform bounty eligibility for security-labeled fixes in the core repo; requires explicit security signals.",
        status="active",
    ),
    ReputationSourcePolicy(
