...
class PlatformFundingRound(Base):
    __tablename__ = "platform_funding_rounds"
    __table_args__ = (
        UniqueConstraint("round_id", name="uq_platform_funding_rounds_round_id"),
        UniqueConstraint("idempotency_key", name="uq_platform_funding_rounds_idempotency_key"),
    )
