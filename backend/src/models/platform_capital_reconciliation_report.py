...
class PlatformCapitalReconciliationReport(Base):
    __tablename__ = "platform_capital_reconciliation_reports"
    __table_args__ = (
        Index("ix_platform_capital_recon_ready_computed", "ready", "computed_at"),
    )

    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    funding_pool_address: Mapped[str] = mapped_column(String(42))
