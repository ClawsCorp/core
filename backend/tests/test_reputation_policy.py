...
def test_investor_points_are_linear_at_small_amounts() -> None:
    ...
    assert calculate_project_investor_points(550_000) == 1
    assert calculate_project_investor_points(1_000_000) == 1
    assert calculate_project_investor_points(5_500_000) == 5


def test_investor_points_cap_is_high_but_bounded() -> None:
    amount_at_cap = INVESTOR_POINTS_CAP_PER_DEPOSIT * 1_000_000
